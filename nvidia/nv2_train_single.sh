...
train_steps=${8:-7820}
#save_checkpoints_steps=${9:-50000}
save_checkpoints_steps=${9:-100}
bert_model=${10:-"large"}
...
DATA_DIR=/home/acc/DeepLearningExamples/TensorFlow/LanguageModeling/BERT/tfrecord_single/
BERT_CONFIG="/home/acc/pretrain2/configs/uncased_large_single/bert_config.json"
PHASE1_CKPT=/home/acc/uncased_results_single/model.ckpt-6700
RESULTS_DIR=/home/acc/uncased_results_single_take2
